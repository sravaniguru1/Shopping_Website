...
function clearTable() {
  var  tablee = document.getElementById("tab");
  tablee.innerHTML = "";
}
function pict() {
  var picture=document.getElementById("one");
  picture.innerText=" "
  console.log(picture);
}

let mens=data.filter(function(value,index,array) {
  return value.category=="men's clothing";

} )
console.log(mens)
let womens=data.filter(function(value,index,array) {
  return value.category == "women's clothing";
} )
let ele=data.filter(function(value,index,array) {
return value.category == "electronics"
}  ) 

let jewel=data.filter(function(value,index,array)  {
...
tre.appendChild(cartTd)
bttn.addEventListener("click",()=>{
  localStorage.setItem("one",JSON.stringify(mens[index]))
  window.location.assign("./view.html")
})
btnadd.addEventListener("click",()=>{
  let currentCart = JSON.parse(localStorage.getItem("cartproduct")) || [];
  currentCart.push(mens[index]);
  localStorage.setItem("cartproduct",JSON.stringify(currentCart))
})
} )
}
...
tre.appendChild(cartTd)
bttn.addEventListener("click",()=>{
  localStorage.setItem("one",JSON.stringify(womens[index]))
  window.location.assign("./view.html")
})
btnadd.addEventListener("click",()=>{
  let currentCart = JSON.parse(localStorage.getItem("cartproduct")) || [];
  currentCart.push(womens[index]);
  localStorage.setItem("cartproduct",JSON.stringify(currentCart))
})
} )
...
tre.appendChild(cartTd)
bttn.addEventListener("click",()=>{
  localStorage.setItem("one",JSON.stringify(ele[index]))
  window.location.assign("./view.html")
})
btnadd.addEventListener("click",()=>{
  let currentCart = JSON.parse(localStorage.getItem("cartproduct")) || [];
  currentCart.push(ele[index]);
  localStorage.setItem("cartproduct",JSON.stringify(currentCart))
})
} )
...
tre.appendChild(cartTd)
bttn.addEventListener("click",()=>{
  localStorage.setItem("one",JSON.stringify(jewel[index]))
  window.location.assign("./view.html")
})
btnadd.addEventListener("click",()=>{
  let currentCart = JSON.parse(localStorage.getItem("cartproduct")) || [];
  currentCart.push(jewel[index]);
  localStorage.setItem("cartproduct",JSON.stringify(currentCart))
})
} )
}